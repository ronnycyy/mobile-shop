...
db_1.default(); // connect mongoDB first.
...
var initData = function () { return __awaiter(void 0, void 0, void 0, function () {
    var createdUsers, adminUserId_1, sampleProducts, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
            ...
            case 4:
                ...
                adminUserId_1 = createdUsers[0]._id;
                sampleProducts = products_1.default.map(function (product) {
                    return __assign(__assign({}, product), { user: adminUserId_1 });
                });
